...
const Footer = () => (
  <section className={`${styles.flexCenter} ${styles.paddingY}  ${styles.paddingX} bg-[#080357] flex-col`}>
    <div className={`${styles.flexStart} px-8 md:px-16 md:flex-row flex-col mb-8  w-full`}>
      <div className="flex-[1] flex flex-col justify-start mr-10">
        
      <img className=" w-[124px] my-2 " src={Logo}/>
        <p className={`${styles.paragraph} text-slate-400 mt-4 max-w-[312px]`}>
