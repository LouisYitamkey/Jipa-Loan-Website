...
import MobileDialogue from "../components/MobileDialog"
...
const Hero = () => {
  return (
    ...
    <div className={`bg-slate-200`}>
     ...
     <img className="w-[80%] pt-14 ml-5 md:ml-0  h-[100%] relative z-[5]" alt="hero" src={HeroImage}/>
     </div>
...
<div className="flex ml-10  md:pb-10 md:ml-16 pt-7">
  ...
  <div className={`flex-1 flex ${styles.flexCenter} md:my-0 my-6 relative`}>
     ...
     <div className="mt-10 md:mt-60">
      ...
      <h3 className="pt-10  text-base md:text-xl"> Get the loan you need with peace of mind. Get a loan from Jipa <br className="hidden md:block"/> and enjoy flexible and affordable  interest rates. <br className="hidden md:block"/>  <br className="md:hidden"/> <br /> Jipa's repayment options make  borrowing   easy and   stress-free. <br className="hidden md:block" />   Apply now and experience worry-free financing with us.</h3>
      <div> 
